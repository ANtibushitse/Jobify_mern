...
#### 15. <a name='AutoImports'></a>Auto Imports
...
#### 25. <a name='ClearAlert'></a>Clear Alert
...
#### 43. <a name='AutoImports-1'></a>Auto Imports
...
#### 53. <a name='ClearAlert-1'></a>Clear Alert
...
#### 57. <a name='NotFoundMiddleware'></a>Not Found Middleware
...
#### 61. <a name='AuthControllerandRouteStructure'></a>Auth Controller and Route Structure
...
#### 85. <a name='LocalStorage'></a>Local Storage
...
#### 87. <a name='UnauthenticatedError'></a>UnauthenticatedError
...
#### 101. <a name='ToggleDropdown'></a>Toggle Dropdown
...
#### 111. <a name='Postman-SetTokenProgrammatically'></a>Postman - Set Token Programmatically
...
#### 127. <a name='SelectInput'></a>Select Input
...
#### 130. <a name='ClearValues'></a>Clear Values
...
#### 131. <a name='CreateJob-1'></a>Create Job
...
#### 135. <a name='AllJobsPageSetup'></a>AllJobs Page Setup
...
#### 151. <a name='ShowStats-FunctionSetup'></a>Show Stats - Function Setup
...
#### 152. <a name='StatsPage-Structure'></a>Stats Page - Structure
...
#### 158. <a name='RechartsLibrary'></a>Recharts Library
...
#### 161. <a name='Filter'></a>Filter

#### 162. <a name='GetAllJobs-InitialSetup'></a>Get All Jobs - Initial Setup
...
#### 166. <a name='SearchContextSetup'></a>Search Context Setup
...
#### 167. <a name='SearchContainer-Setup'></a>Search Container - Setup
...
#### 168. <a name='SearchContainer-Complete'></a>Search Container - Complete
...
#### 169. <a name='ClearFilters'></a>Clear Filters
...
#### 170. <a name='RefactorGetAllJobs'></a>Refactor Get All Jobs
...
#### 171. <a name='LimitandSkip'></a>Limit and Skip
...
#### 172. <a name='PageandLimit'></a>Page and Limit
...
#### 173. <a name='TotalJobsandNumberOfPages'></a>Total Jobs and Number Of Pages
...
#### 174. <a name='PageBtnContainerSetup'></a>PageBtnContainer Setup
...
#### 175. <a name='PageBtnContainer-Structure'></a>PageBtnContainer - Structure
...
#### 176. <a name='ButtonContainer'></a>Button Container
...
#### 177. <a name='ChangePage'></a>Change Page
...
#### 178. <a name='PrevandNextButtons'></a>Prev and Next Buttons
...
#### 179. <a name='TriggerNewPage'></a>Trigger New Page
...
#### 180. <a name='ProductionSetup-FixWarningsandlogoutUser'></a>Production Setup - Fix Warnings and logoutUser
...
#### 181. <a name='ProductionSetup-BuildFront-EndApplication'></a>Production Setup - Build Front-End Application
...
#### 182. <a name='SecurityPackages'></a>Security Packages
...
#### 183. <a name='LimitRequests'></a>Limit Requests
...
#### 184. <a name='DeployToHeroku'></a>Deploy To Heroku
